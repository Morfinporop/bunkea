...
const PROFESSIONS = [
  'Нейрохирург', 'Военный тактик', 'Агроном', 'Инженер-ядерщик', 'Психолог',
  'Ветеринар', 'Повар', 'Механик', 'Биолог', 'Электрик',
  'Учитель', 'Программист', 'Строитель', 'Медсестра', 'Шахтёр',
  'Охранник', 'Фермер', 'Химик', 'Радиолог', 'Пожарный',
  'Снайпер', 'Садовник', 'Физик', 'Геолог', 'Врач-терапевт',
  'Стоматолог', 'Плотник', 'Акушер', 'Микробиолог', 'Сварщик'
];

const HEALTH = [
  'Абсолютно здоров', 'Лёгкое плоскостопие', 'Аллергия на пыльцу',
  'Хронический гастрит', 'Близорукость -2', 'Дальнозоркость +3',
  'Гипертония 1 степени', 'Сахарный диабет 2 типа', 'Лёгкая форма астмы',
  'Варикоз вен', 'Искусственный сустав', 'Нейтрализованный туберкулёз',
  'Слабый иммунитет', 'Беременна (6 мес.)', 'Клаустрофобия',
  'ВИЧ-носитель (не активен)', 'Сломанная рука (залечена)', 'Глухота на одно ухо',
  'Протез ноги', 'Эпилепсия (редкие припадки)', 'Онкология в ремиссии',
  'Тяжёлая депрессия', 'Бессонница хроническая', 'Идеальное здоровье'
];

const HOBBIES = [
  'Рыбалка', 'Охота', 'Садоводство', 'Шахматы', 'Радиолюбительство',
  'Выживание в дикой природе', 'Кулинария экзотических блюд', 'Рукопашный бой',
  'Стрельба из лука', 'Медитация и йога', 'Ведение дневника',
  'Изучение языков', 'Ремонт техники', 'Гончарное дело', 'Пение',
  'Коллекционирование семян', 'Программирование', 'Астрономия',
  'Акробатика', 'Резьба по дереву', 'Плавание', 'Боевые искусства',
  'Травничество', 'Картография', 'Кузнечное дело'
];

const LUGGAGE = [
  'Швейцарский нож', 'Аптечка', 'Семена овощей', 'Генератор', 'Ноутбук с базами данных',
  'Охотничье ружьё и патроны', 'Спутниковый телефон', 'Книга по хирургии',
  'Запас антибиотиков на год', 'Портативная солнечная панель',
  'Верёвки и карабины', 'Рыболовные снасти', 'Средства дезинфекции',
  'Ничего', 'Набор инструментов', 'Сборник законов', 'Молитвенник',
  'Фотоальбом', 'Карты местности', 'Радиоприёмник', 'Армейские пайки x10',
  'Химические анализаторы', 'Зеркало для сигналов', 'Бинокль',
  'Набор семян редких растений', 'Запасные очки', 'Музыкальный инструмент'
];
...
const EXTRA_FACTS = [
  'Единственный выживший в авиакатастрофе', 'Бывший агент спецслужб',
  'Знает 4 языка', 'Прожил год в изоляции в тайге', 'Чемпион мира по шахматам',
  'Имеет доступ к секретным архивам', 'Обладает фотографической памятью',
  'Умеет гипнотизировать людей', 'Бывший заключённый (оправдан)',
  'Единственный ребёнок среди взрослых (12 лет)', 'Имеет иммунитет к яду',
  'Знает расположение всех бункеров в регионе', 'Двойник известного политика',
  'Несёт в себе редкий ген устойчивости к вирусам', 'Обычный человек без особенностей',
  'Была жертвой эксперимента правительства', 'Знает формулу сыворотки от болезни',
  'Бывший культист', 'Является роботом (почти неотличимым)', 'Всё лжёт о себе'
];
